...
## [2026.8.1]
### Fixed
* Remove `affects` from flaw list/search `include_fields` to improve Advanced Search performance
...
* Fix missing error notifications on affect updates (`OSIDB-5196`)
...
[Unreleased]: https://github.com/RedHatProductSecurity/osim/compare/v2026.8.0...HEAD
