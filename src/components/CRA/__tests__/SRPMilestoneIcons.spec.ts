...
describe('sRPMilestoneIcons', () => {
  ...
  it('shows circle-fill with warning color for in_progress status', () => {
    const report = createReport([
      createMilestone({ status: 'in_progress' }),
    ]);
  ...
  it('shows circle with muted color for obsolete status', () => {
    const report = createReport([
      createMilestone({ status: 'obsolete' }),
    ]);
  ...
  it('shows circle-fill with info color for in_review status', () => {
    const report = createReport([
      createMilestone({ status: 'in_review' }),
    ]);
  ...
  it('includes status in tooltip with capitalization', () => {
    const report = createReport([
      createMilestone({ milestone_type: '24h', status: 'in_progress' }),
    ]);
  ...
  it('handles multiple milestones in order', () => {
    const report = createReport([
      ...
      createMilestone({ milestone_type: '72h', status: 'in_progress', uuid: 'm2' }),
      createMilestone({ milestone_type: 'final', status: 'obsolete', uuid: 'm3' }),
    ]);
