...
describe('sRPPayloadDialog', () => {
  ...
  it('renders requirement badges under field names except copied/updateable', () => {
    const milestone = {
    ...
    expect(wrapper.findAll('.requirement-badge').some(badge => badge.text() === 'Copied/updateable'))
      .toBe(false);
