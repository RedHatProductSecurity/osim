          ...
          >
            <template #labelSlot>
              <i
                ...
                title="Generated by Aegis-AI-Bot"
              ></i>
              <AegisTitleActions
          ...
          >
            <template #label>
              <div class="d-flex align-items-center flex-nowrap" style="min-width: max-content;">
                ...
                ></i>
                <!-- Feedback buttons for OSIDB-Bot highlighted components -->
                <template v-if="canShowComponentsFeedback">
                  <i
                    ...
                    title="Mark OSIDB-Bot suggestion helpful"
                    @click.prevent.stop="handleComponentsFeedback('positive', '')"
                  />
                  <i
                    class="bi-hand-thumbs-down"
                    style="color: gray; cursor: pointer; margin-right: 0.25rem; font-size: 0.9em;"
                    title="Mark OSIDB-Bot suggestion unhelpful"
