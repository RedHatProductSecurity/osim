...
const nameForOption = (fieldName: string) => {
  const mappings: Record<string, string> = {
    ...
    affects__tracker__ps_update_stream: 'Affect Update Stream',
    acknowledgments__name: 'Acknowledgment Author',
    affects__tracker__errata__advisory_name: 'Errata Advisory Name',
    affects__tracker__external_system_id: 'Tracker External System ID',
