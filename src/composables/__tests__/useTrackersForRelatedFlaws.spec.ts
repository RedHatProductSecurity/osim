...
describe('useRelatedFlawTrackers', () => {
  ...
  it('computes untracked affects correctly', async () => {
    const { multiFlawTrackers } = await mockTrackers(flaw, relatedFlaws);
  ...
  it('computes untrackableAffects correctly', async () => {
    ...
    const { multiFlawTrackers } = await mockTrackers(flaw, relatedFlaws, sampleTrackers);
  ...
  it('computes availableUpdateStreams correctly', async () => {
    const trackers = await mockTrackers(flaw, relatedFlaws);
    ...
    expect(availableUpdateStreams).toEqual([
      {
