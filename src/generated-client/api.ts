 ...
 * @export
 * @interface CVEv5PackageVersions
 */
export interface CVEv5PackageVersions {
    /**
     * 
     * @type {string}
     * @memberof CVEv5PackageVersions
     */
    'package': string;
    /**
     * 
     * @type {Array<CVEv5Versions>}
     * @memberof CVEv5PackageVersions
     */
    'versions': Array<CVEv5Versions>;
}
/**
 * CVEv5 Package Version Serializer
 * @export
 * @interface CVEv5Versions
 */
export interface CVEv5Versions {
    /**
     * 
     * @type {string}
     * @memberof CVEv5Versions
     */
    'version': string;
    /**
     * 
...
export interface Flaw {
    ...
    /**
     * 
     * @type {Array<CVEv5PackageVersions>}
     * @memberof Flaw
     */
    'package_versions': Array<CVEv5PackageVersions>;
    /**
     * 
...
export const OsidbApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        osidbApiV1AffectsCreate: async (affectPost: AffectPost, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {number} [limit] Number of results to return per page.
         * @param {number} [offset] The initial index from which to return the results.
         * @param {Array<'-affectedness' | '-created_dt' | '-cvss2' | '-cvss2_score' | '-cvss3' | '-cvss3_score' | '-flaw__component' | '-flaw__created_dt' | '-flaw__cve_id' | '-flaw__cvss2' | '-flaw__cvss2_score' | '-flaw__cvss3' | '-flaw__cvss3_score' | '-flaw__cwe_id' | '-flaw__impact' | '-flaw__nvd_cvss2' | '-flaw__nvd_cvss3' | '-flaw__reported_dt' | '-flaw__source' | '-flaw__type' | '-flaw__unembargo_dt' | '-flaw__updated_dt' | '-flaw__uuid' | '-impact' | '-ps_component' | '-ps_module' | '-resolution' | '-trackers__created_dt' | '-trackers__external_system_id' | '-trackers__ps_update_stream' | '-trackers__resolution' | '-trackers__status' | '-trackers__type' | '-trackers__updated_dt' | '-trackers__uuid' | '-type' | '-updated_dt' | '-uuid' | 'affectedness' | 'created_dt' | 'cvss2' | 'cvss2_score' | 'cvss3' | 'cvss3_score' | 'flaw__component' | 'flaw__created_dt' | 'flaw__cve_id' | 'flaw__cvss2' | 'flaw__cvss2_score' | 'flaw__cvss3' | 'flaw__cvss3_score' | 'flaw__cwe_id' | 'flaw__impact' | 'flaw__nvd_cvss2' | 'flaw__nvd_cvss3' | 'flaw__reported_dt' | 'flaw__source' | 'flaw__type' | 'flaw__unembargo_dt' | 'flaw__updated_dt' | 'flaw__uuid' | 'impact' | 'ps_component' | 'ps_module' | 'resolution' | 'trackers__created_dt' | 'trackers__external_system_id' | 'trackers__ps_update_stream' | 'trackers__resolution' | 'trackers__status' | 'trackers__type' | 'trackers__updated_dt' | 'trackers__uuid' | 'type' | 'updated_dt' | 'uuid'>} [order] Ordering
         ...
         * @throws {RequiredError}
         */
        osidbApiV1AffectsUpdate: async (uuid: string, affect: Affect, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'uuid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsCreate: async (flawPost: FlawPost, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsReferencesList: async (flawId: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, limit?: number, offset?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'flawId' is not null or undefined
         ...
         * @param {string} flawId 
         * @param {string} id 
         * @param {FlawReference} flawReference 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        osidbApiV1FlawsReferencesUpdate: async (flawId: string, id: string, flawReference: FlawReference, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'flawId' is not null or undefined
            assertParamExists('osidbApiV1FlawsReferencesUpdate', 'flawId', flawId)
            // verify required parameter 'id' is not null or undefined
            assertParamExists('osidbApiV1FlawsReferencesUpdate', 'id', id)
            // verify required parameter 'flawReference' is not null or undefined
            assertParamExists('osidbApiV1FlawsReferencesUpdate', 'flawReference', flawReference)
            const localVarPath = `/osidb/api/v1/flaws/{flaw_id}/references/{id}`
                .replace(`{${"flaw_id"}}`, encodeURIComponent(String(flawId)))
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(flawReference, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsUpdate: async (id: string, flaw: Flaw, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const OsidbApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1AffectsCreate(affectPost: AffectPost, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1AffectsCreate201Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.osidbApiV1AffectsCreate(affectPost, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1AffectsUpdate(uuid: string, affect: Affect, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1AffectsCreate201Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.osidbApiV1AffectsUpdate(uuid, affect, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1FlawsCreate(flawPost: FlawPost, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1FlawsCreate201Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.osidbApiV1FlawsCreate(flawPost, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1FlawsReferencesList(flawId: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1FlawsReferencesList200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.osidbApiV1FlawsReferencesList(flawId, excludeFields, includeFields, includeMetaAttr, limit, offset, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1FlawsReferencesUpdate(flawId: string, id: string, flawReference: FlawReference, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1FlawsReferencesCreate201Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.osidbApiV1FlawsReferencesUpdate(flawId, id, flawReference, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1FlawsUpdate(id: string, flaw: Flaw, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1FlawsCreate201Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.osidbApiV1FlawsUpdate(id, flaw, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * HTTP get /manifest
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1TrackersRetrieve(uuid: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1TrackersRetrieve200Response>> {
...
export const OsidbApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        osidbApiV1AffectsCreate(affectPost: AffectPost, options?: any): AxiosPromise<OsidbApiV1AffectsCreate201Response> {
            return localVarFp.osidbApiV1AffectsCreate(affectPost, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} uuid A UUID string identifying this Affect.
         ...
         * @throws {RequiredError}
         */
        osidbApiV1AffectsUpdate(uuid: string, affect: Affect, options?: any): AxiosPromise<OsidbApiV1AffectsCreate201Response> {
            return localVarFp.osidbApiV1AffectsUpdate(uuid, affect, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} flawId 
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsCreate(flawPost: FlawPost, options?: any): AxiosPromise<OsidbApiV1FlawsCreate201Response> {
            return localVarFp.osidbApiV1FlawsCreate(flawPost, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} [acknowledgmentsAffiliation] 
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsReferencesList(flawId: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, limit?: number, offset?: number, options?: any): AxiosPromise<OsidbApiV1FlawsReferencesList200Response> {
            return localVarFp.osidbApiV1FlawsReferencesList(flawId, excludeFields, includeFields, includeMetaAttr, limit, offset, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} flawId 
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsReferencesUpdate(flawId: string, id: string, flawReference: FlawReference, options?: any): AxiosPromise<OsidbApiV1FlawsReferencesCreate201Response> {
            return localVarFp.osidbApiV1FlawsReferencesUpdate(flawId, id, flawReference, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id A string representing either the internal OSIDB UUID of the Flaw resource or the CVE number corresponding to a Flaw
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsUpdate(id: string, flaw: Flaw, options?: any): AxiosPromise<OsidbApiV1FlawsCreate201Response> {
            return localVarFp.osidbApiV1FlawsUpdate(id, flaw, options).then((request) => request(axios, basePath));
        },
        /**
         * HTTP get /manifest
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        osidbApiV1TrackersRetrieve(uuid: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, options?: any): AxiosPromise<OsidbApiV1TrackersRetrieve200Response> {
...
export class OsidbApi extends BaseAPI {
     ...
     * @memberof OsidbApi
     */
    public osidbApiV1AffectsCreate(affectPost: AffectPost, options?: AxiosRequestConfig) {
        return OsidbApiFp(this.configuration).osidbApiV1AffectsCreate(affectPost, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OsidbApi
     */
    public osidbApiV1AffectsUpdate(uuid: string, affect: Affect, options?: AxiosRequestConfig) {
        return OsidbApiFp(this.configuration).osidbApiV1AffectsUpdate(uuid, affect, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OsidbApi
     */
    public osidbApiV1FlawsCreate(flawPost: FlawPost, options?: AxiosRequestConfig) {
        return OsidbApiFp(this.configuration).osidbApiV1FlawsCreate(flawPost, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OsidbApi
     */
    public osidbApiV1FlawsReferencesList(flawId: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, limit?: number, offset?: number, options?: AxiosRequestConfig) {
        return OsidbApiFp(this.configuration).osidbApiV1FlawsReferencesList(flawId, excludeFields, includeFields, includeMetaAttr, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OsidbApi
     */
    public osidbApiV1FlawsReferencesUpdate(flawId: string, id: string, flawReference: FlawReference, options?: AxiosRequestConfig) {
        return OsidbApiFp(this.configuration).osidbApiV1FlawsReferencesUpdate(flawId, id, flawReference, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OsidbApi
     */
    public osidbApiV1FlawsUpdate(id: string, flaw: Flaw, options?: AxiosRequestConfig) {
        return OsidbApiFp(this.configuration).osidbApiV1FlawsUpdate(id, flaw, options).then((request) => request(this.axios, this.basePath));
    }
...
export const TaskmanApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         * @param {string} name 
         * @param {string} [description] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        taskmanApiV1GroupCreate: async (jiraAuthentication: string, name: string, description?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1GroupCreate', 'jiraAuthentication', jiraAuthentication)
            ...
            if (jiraAuthentication != null) {
                localVarHeaderParameter['JiraAuthentication'] = String(jiraAuthentication);
            }
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1GroupRetrieve: async (jiraAuthentication: string, groupKey: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1GroupRetrieve', 'jiraAuthentication', jiraAuthentication)
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1GroupUpdate: async (jiraAuthentication: string, groupKey: string, taskKey: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1GroupUpdate', 'jiraAuthentication', jiraAuthentication)
            // verify required parameter 'groupKey' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskAssigneeRetrieve: async (jiraAuthentication: string, user: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskAssigneeRetrieve', 'jiraAuthentication', jiraAuthentication)
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskAssigneeUpdate: async (jiraAuthentication: string, taskKey: string, user: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskAssigneeUpdate', 'jiraAuthentication', jiraAuthentication)
            // verify required parameter 'taskKey' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskCommentCreate: async (jiraAuthentication: string, content: string, taskKey: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskCommentCreate', 'jiraAuthentication', jiraAuthentication)
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskCommentUpdate: async (jiraAuthentication: string, commentId: string, content: string, taskKey: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskCommentUpdate', 'jiraAuthentication', jiraAuthentication)
            // verify required parameter 'commentId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskFlawCreate: async (jiraAuthentication: string, flawUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskFlawCreate', 'jiraAuthentication', jiraAuthentication)
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskFlawRetrieve: async (jiraAuthentication: string, flawUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskFlawRetrieve', 'jiraAuthentication', jiraAuthentication)
            // verify required parameter 'flawUuid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskFlawUpdate: async (jiraAuthentication: string, flawUuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskFlawUpdate', 'jiraAuthentication', jiraAuthentication)
            // verify required parameter 'flawUuid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskRetrieve: async (jiraAuthentication: string, taskKey: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskRetrieve', 'jiraAuthentication', jiraAuthentication)
            // verify required parameter 'taskKey' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskStatusUpdate: async (jiraAuthentication: string, status: 'Closed' | 'In Progress' | 'New' | 'Refinement', taskKey: string, reason?: 'Closed' | 'In Progress' | 'New' | 'Refinement', resolution?: 'Can\'t Do' | 'Cannot Reproduce' | 'Done' | 'Done-Errata' | 'Duplicate' | 'MirrorOrphan' | 'Not a Bug' | 'Obsolete' | 'Test Pending' | 'Won\'t Do', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskStatusUpdate', 'jiraAuthentication', jiraAuthentication)
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskUnassignedRetrieve: async (jiraAuthentication: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'jiraAuthentication' is not null or undefined
            assertParamExists('taskmanApiV1TaskUnassignedRetrieve', 'jiraAuthentication', jiraAuthentication)
...
export const TaskmanApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1GroupCreate(jiraAuthentication: string, name: string, description?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskmanApiV1GroupCreate200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1GroupCreate(jiraAuthentication, name, description, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a list of tasks from a group
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1GroupRetrieve(jiraAuthentication: string, groupKey: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskmanApiV1GroupRetrieve200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1GroupRetrieve(jiraAuthentication, groupKey, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Add a task into a group
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1GroupUpdate(jiraAuthentication: string, groupKey: string, taskKey: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthTokenCreate200ResponseAllOf>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1GroupUpdate(jiraAuthentication, groupKey, taskKey, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a list of tasks from a user
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskAssigneeRetrieve(jiraAuthentication: string, user: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskmanApiV1GroupRetrieve200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskAssigneeRetrieve(jiraAuthentication, user, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Assign a task to a user
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskAssigneeUpdate(jiraAuthentication: string, taskKey: string, user: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthTokenCreate200ResponseAllOf>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskAssigneeUpdate(jiraAuthentication, taskKey, user, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Create a new comment in a task
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskCommentCreate(jiraAuthentication: string, content: string, taskKey: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskmanApiV1TaskCommentCreate200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskCommentCreate(jiraAuthentication, content, taskKey, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Edit a comment in a task
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskCommentUpdate(jiraAuthentication: string, commentId: string, content: string, taskKey: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskmanApiV1TaskCommentCreate200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskCommentUpdate(jiraAuthentication, commentId, content, taskKey, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Create a task in Jira from a Flaw
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskFlawCreate(jiraAuthentication: string, flawUuid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthTokenCreate200ResponseAllOf>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskFlawCreate(jiraAuthentication, flawUuid, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a task from Jira given a Flaw uuid
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskFlawRetrieve(jiraAuthentication: string, flawUuid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskmanApiV1GroupCreate200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskFlawRetrieve(jiraAuthentication, flawUuid, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a task in Jira from a Flaw
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskFlawUpdate(jiraAuthentication: string, flawUuid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthTokenCreate200ResponseAllOf>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskFlawUpdate(jiraAuthentication, flawUuid, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a task from Jira given a task key
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskRetrieve(jiraAuthentication: string, taskKey: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskmanApiV1GroupCreate200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskRetrieve(jiraAuthentication, taskKey, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Change a task workflow status
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskStatusUpdate(jiraAuthentication: string, status: 'Closed' | 'In Progress' | 'New' | 'Refinement', taskKey: string, reason?: 'Closed' | 'In Progress' | 'New' | 'Refinement', resolution?: 'Can\'t Do' | 'Cannot Reproduce' | 'Done' | 'Done-Errata' | 'Duplicate' | 'MirrorOrphan' | 'Not a Bug' | 'Obsolete' | 'Test Pending' | 'Won\'t Do', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthTokenCreate200ResponseAllOf>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskStatusUpdate(jiraAuthentication, status, taskKey, reason, resolution, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a list of tasks without an user assigned
         ...
         * @throws {RequiredError}
         */
        async taskmanApiV1TaskUnassignedRetrieve(jiraAuthentication: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TaskmanApiV1GroupRetrieve200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.taskmanApiV1TaskUnassignedRetrieve(jiraAuthentication, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * unauthenticated health check API endpoint
...
export const TaskmanApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1GroupCreate(jiraAuthentication: string, name: string, description?: string, options?: any): AxiosPromise<TaskmanApiV1GroupCreate200Response> {
            return localVarFp.taskmanApiV1GroupCreate(jiraAuthentication, name, description, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a list of tasks from a group
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1GroupRetrieve(jiraAuthentication: string, groupKey: string, options?: any): AxiosPromise<TaskmanApiV1GroupRetrieve200Response> {
            return localVarFp.taskmanApiV1GroupRetrieve(jiraAuthentication, groupKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Add a task into a group
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1GroupUpdate(jiraAuthentication: string, groupKey: string, taskKey: string, options?: any): AxiosPromise<AuthTokenCreate200ResponseAllOf> {
            return localVarFp.taskmanApiV1GroupUpdate(jiraAuthentication, groupKey, taskKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a list of tasks from a user
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskAssigneeRetrieve(jiraAuthentication: string, user: string, options?: any): AxiosPromise<TaskmanApiV1GroupRetrieve200Response> {
            return localVarFp.taskmanApiV1TaskAssigneeRetrieve(jiraAuthentication, user, options).then((request) => request(axios, basePath));
        },
        /**
         * Assign a task to a user
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskAssigneeUpdate(jiraAuthentication: string, taskKey: string, user: string, options?: any): AxiosPromise<AuthTokenCreate200ResponseAllOf> {
            return localVarFp.taskmanApiV1TaskAssigneeUpdate(jiraAuthentication, taskKey, user, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a new comment in a task
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskCommentCreate(jiraAuthentication: string, content: string, taskKey: string, options?: any): AxiosPromise<TaskmanApiV1TaskCommentCreate200Response> {
            return localVarFp.taskmanApiV1TaskCommentCreate(jiraAuthentication, content, taskKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Edit a comment in a task
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskCommentUpdate(jiraAuthentication: string, commentId: string, content: string, taskKey: string, options?: any): AxiosPromise<TaskmanApiV1TaskCommentCreate200Response> {
            return localVarFp.taskmanApiV1TaskCommentUpdate(jiraAuthentication, commentId, content, taskKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Create a task in Jira from a Flaw
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskFlawCreate(jiraAuthentication: string, flawUuid: string, options?: any): AxiosPromise<AuthTokenCreate200ResponseAllOf> {
            return localVarFp.taskmanApiV1TaskFlawCreate(jiraAuthentication, flawUuid, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a task from Jira given a Flaw uuid
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskFlawRetrieve(jiraAuthentication: string, flawUuid: string, options?: any): AxiosPromise<TaskmanApiV1GroupCreate200Response> {
            return localVarFp.taskmanApiV1TaskFlawRetrieve(jiraAuthentication, flawUuid, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a task in Jira from a Flaw
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskFlawUpdate(jiraAuthentication: string, flawUuid: string, options?: any): AxiosPromise<AuthTokenCreate200ResponseAllOf> {
            return localVarFp.taskmanApiV1TaskFlawUpdate(jiraAuthentication, flawUuid, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a task from Jira given a task key
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskRetrieve(jiraAuthentication: string, taskKey: string, options?: any): AxiosPromise<TaskmanApiV1GroupCreate200Response> {
            return localVarFp.taskmanApiV1TaskRetrieve(jiraAuthentication, taskKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Change a task workflow status
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskStatusUpdate(jiraAuthentication: string, status: 'Closed' | 'In Progress' | 'New' | 'Refinement', taskKey: string, reason?: 'Closed' | 'In Progress' | 'New' | 'Refinement', resolution?: 'Can\'t Do' | 'Cannot Reproduce' | 'Done' | 'Done-Errata' | 'Duplicate' | 'MirrorOrphan' | 'Not a Bug' | 'Obsolete' | 'Test Pending' | 'Won\'t Do', options?: any): AxiosPromise<AuthTokenCreate200ResponseAllOf> {
            return localVarFp.taskmanApiV1TaskStatusUpdate(jiraAuthentication, status, taskKey, reason, resolution, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a list of tasks without an user assigned
         * @param {string} jiraAuthentication User generated token for Jira authentication.
         ...
         * @throws {RequiredError}
         */
        taskmanApiV1TaskUnassignedRetrieve(jiraAuthentication: string, options?: any): AxiosPromise<TaskmanApiV1GroupRetrieve200Response> {
            return localVarFp.taskmanApiV1TaskUnassignedRetrieve(jiraAuthentication, options).then((request) => request(axios, basePath));
        },
        /**
         * unauthenticated health check API endpoint
         * @param {*} [options] Override http request option.
...
export class TaskmanApi extends BaseAPI {
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1GroupCreate(jiraAuthentication: string, name: string, description?: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1GroupCreate(jiraAuthentication, name, description, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1GroupRetrieve(jiraAuthentication: string, groupKey: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1GroupRetrieve(jiraAuthentication, groupKey, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1GroupUpdate(jiraAuthentication: string, groupKey: string, taskKey: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1GroupUpdate(jiraAuthentication, groupKey, taskKey, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskAssigneeRetrieve(jiraAuthentication: string, user: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskAssigneeRetrieve(jiraAuthentication, user, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskAssigneeUpdate(jiraAuthentication: string, taskKey: string, user: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskAssigneeUpdate(jiraAuthentication, taskKey, user, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskCommentCreate(jiraAuthentication: string, content: string, taskKey: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskCommentCreate(jiraAuthentication, content, taskKey, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskCommentUpdate(jiraAuthentication: string, commentId: string, content: string, taskKey: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskCommentUpdate(jiraAuthentication, commentId, content, taskKey, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskFlawCreate(jiraAuthentication: string, flawUuid: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskFlawCreate(jiraAuthentication, flawUuid, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskFlawRetrieve(jiraAuthentication: string, flawUuid: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskFlawRetrieve(jiraAuthentication, flawUuid, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskFlawUpdate(jiraAuthentication: string, flawUuid: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskFlawUpdate(jiraAuthentication, flawUuid, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskRetrieve(jiraAuthentication: string, taskKey: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskRetrieve(jiraAuthentication, taskKey, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskStatusUpdate(jiraAuthentication: string, status: 'Closed' | 'In Progress' | 'New' | 'Refinement', taskKey: string, reason?: 'Closed' | 'In Progress' | 'New' | 'Refinement', resolution?: 'Can\'t Do' | 'Cannot Reproduce' | 'Done' | 'Done-Errata' | 'Duplicate' | 'MirrorOrphan' | 'Not a Bug' | 'Obsolete' | 'Test Pending' | 'Won\'t Do', options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskStatusUpdate(jiraAuthentication, status, taskKey, reason, resolution, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TaskmanApi
     */
    public taskmanApiV1TaskUnassignedRetrieve(jiraAuthentication: string, options?: AxiosRequestConfig) {
        return TaskmanApiFp(this.configuration).taskmanApiV1TaskUnassignedRetrieve(jiraAuthentication, options).then((request) => request(this.axios, this.basePath));
    }
