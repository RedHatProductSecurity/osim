...
export const OsidbApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} [limit] Number of results to return per page.
         * @param {number} [offset] The initial index from which to return the results.
         * @param {Array<'-affectedness' | '-created_dt' | '-cvss2' | '-cvss2_score' | '-cvss3' | '-cvss3_score' | '-cvss_scores__comment' | '-cvss_scores__created_dt' | '-cvss_scores__cvss_version' | '-cvss_scores__issuer' | '-cvss_scores__score' | '-cvss_scores__updated_dt' | '-cvss_scores__uuid' | '-cvss_scores__vector' | '-embargoed' | '-flaw__component' | '-flaw__components' | '-flaw__created_dt' | '-flaw__cve_id' | '-flaw__cvss2' | '-flaw__cvss2_score' | '-flaw__cvss3' | '-flaw__cvss3_score' | '-flaw__cwe_id' | '-flaw__embargoed' | '-flaw__impact' | '-flaw__is_major_incident' | '-flaw__nvd_cvss2' | '-flaw__nvd_cvss3' | '-flaw__reported_dt' | '-flaw__source' | '-flaw__type' | '-flaw__unembargo_dt' | '-flaw__updated_dt' | '-flaw__uuid' | '-impact' | '-ps_component' | '-ps_module' | '-resolution' | '-trackers__created_dt' | '-trackers__embargoed' | '-trackers__external_system_id' | '-trackers__ps_update_stream' | '-trackers__resolution' | '-trackers__status' | '-trackers__type' | '-trackers__updated_dt' | '-trackers__uuid' | '-type' | '-updated_dt' | '-uuid' | 'affectedness' | 'created_dt' | 'cvss2' | 'cvss2_score' | 'cvss3' | 'cvss3_score' | 'cvss_scores__comment' | 'cvss_scores__created_dt' | 'cvss_scores__cvss_version' | 'cvss_scores__issuer' | 'cvss_scores__score' | 'cvss_scores__updated_dt' | 'cvss_scores__uuid' | 'cvss_scores__vector' | 'embargoed' | 'flaw__component' | 'flaw__components' | 'flaw__created_dt' | 'flaw__cve_id' | 'flaw__cvss2' | 'flaw__cvss2_score' | 'flaw__cvss3' | 'flaw__cvss3_score' | 'flaw__cwe_id' | 'flaw__embargoed' | 'flaw__impact' | 'flaw__is_major_incident' | 'flaw__nvd_cvss2' | 'flaw__nvd_cvss3' | 'flaw__reported_dt' | 'flaw__source' | 'flaw__type' | 'flaw__unembargo_dt' | 'flaw__updated_dt' | 'flaw__uuid' | 'impact' | 'ps_component' | 'ps_module' | 'resolution' | 'trackers__created_dt' | 'trackers__embargoed' | 'trackers__external_system_id' | 'trackers__ps_update_stream' | 'trackers__resolution' | 'trackers__status' | 'trackers__type' | 'trackers__updated_dt' | 'trackers__uuid' | 'type' | 'updated_dt' | 'uuid'>} [order] Ordering
         ...
         * @param {number} [offset] The initial index from which to return the results.
         * @param {'affect' | 'affectcvss' | 'flaw' | 'flawacknowledgment' | 'flawcomment' | 'flawcvss' | 'flawmeta' | 'flawreference' | 'package' | 'snippet' | 'tracker'} [parentModel] Retrieve only Alerts related to the specified model, e.g. flaw or affect.
         * @param {string} [parentUuid] Retrieve only Alerts related to a model with the given UUID.
         * @param {string} [uuid] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        osidbApiV1AlertsList: async (alertType?: 'ERROR' | 'WARNING', excludeFields?: Array<string>, includeFields?: Array<string>, limit?: number, name?: string, offset?: number, parentModel?: 'affect' | 'affectcvss' | 'flaw' | 'flawacknowledgment' | 'flawcomment' | 'flawcvss' | 'flawmeta' | 'flawreference' | 'package' | 'snippet' | 'tracker', parentUuid?: string, uuid?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {number} [limit] Number of results to return per page.
         * @param {number} [offset] The initial index from which to return the results.
         * @param {Array<'-affects__affectedness' | '-affects__created_dt' | '-affects__cvss2' | '-affects__cvss2_score' | '-affects__cvss3' | '-affects__cvss3_score' | '-affects__embargoed' | '-affects__flaw__component' | '-affects__flaw__components' | '-affects__flaw__created_dt' | '-affects__flaw__cve_id' | '-affects__flaw__cvss2' | '-affects__flaw__cvss2_score' | '-affects__flaw__cvss3' | '-affects__flaw__cvss3_score' | '-affects__flaw__cwe_id' | '-affects__flaw__embargoed' | '-affects__flaw__impact' | '-affects__flaw__is_major_incident' | '-affects__flaw__nvd_cvss2' | '-affects__flaw__nvd_cvss3' | '-affects__flaw__reported_dt' | '-affects__flaw__source' | '-affects__flaw__type' | '-affects__flaw__unembargo_dt' | '-affects__flaw__updated_dt' | '-affects__flaw__uuid' | '-affects__impact' | '-affects__ps_component' | '-affects__ps_module' | '-affects__resolution' | '-affects__type' | '-affects__updated_dt' | '-affects__uuid' | '-created_dt' | '-embargoed' | '-external_system_id' | '-ps_update_stream' | '-resolution' | '-status' | '-type' | '-updated_dt' | '-uuid' | 'affects__affectedness' | 'affects__created_dt' | 'affects__cvss2' | 'affects__cvss2_score' | 'affects__cvss3' | 'affects__cvss3_score' | 'affects__embargoed' | 'affects__flaw__component' | 'affects__flaw__components' | 'affects__flaw__created_dt' | 'affects__flaw__cve_id' | 'affects__flaw__cvss2' | 'affects__flaw__cvss2_score' | 'affects__flaw__cvss3' | 'affects__flaw__cvss3_score' | 'affects__flaw__cwe_id' | 'affects__flaw__embargoed' | 'affects__flaw__impact' | 'affects__flaw__is_major_incident' | 'affects__flaw__nvd_cvss2' | 'affects__flaw__nvd_cvss3' | 'affects__flaw__reported_dt' | 'affects__flaw__source' | 'affects__flaw__type' | 'affects__flaw__unembargo_dt' | 'affects__flaw__updated_dt' | 'affects__flaw__uuid' | 'affects__impact' | 'affects__ps_component' | 'affects__ps_module' | 'affects__resolution' | 'affects__type' | 'affects__updated_dt' | 'affects__uuid' | 'created_dt' | 'embargoed' | 'external_system_id' | 'ps_update_stream' | 'resolution' | 'status' | 'type' | 'updated_dt' | 'uuid'>} [order] Ordering
...
export const OsidbApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1AlertsList(alertType?: 'ERROR' | 'WARNING', excludeFields?: Array<string>, includeFields?: Array<string>, limit?: number, name?: string, offset?: number, parentModel?: 'affect' | 'affectcvss' | 'flaw' | 'flawacknowledgment' | 'flawcomment' | 'flawcvss' | 'flawmeta' | 'flawreference' | 'package' | 'snippet' | 'tracker', parentUuid?: string, uuid?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1AlertsList200Response>> {
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1FlawsPromoteCreate(jiraApiKey: string, flawId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthTokenCreate200ResponseAllOf>> {
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1FlawsRejectCreate(jiraApiKey: string, flawId: string, reject: Reject, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthTokenCreate200ResponseAllOf>> {
...
export const OsidbApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        osidbApiV1AlertsList(alertType?: 'ERROR' | 'WARNING', excludeFields?: Array<string>, includeFields?: Array<string>, limit?: number, name?: string, offset?: number, parentModel?: 'affect' | 'affectcvss' | 'flaw' | 'flawacknowledgment' | 'flawcomment' | 'flawcvss' | 'flawmeta' | 'flawreference' | 'package' | 'snippet' | 'tracker', parentUuid?: string, uuid?: string, options?: any): AxiosPromise<OsidbApiV1AlertsList200Response> {
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsPromoteCreate(jiraApiKey: string, flawId: string, options?: any): AxiosPromise<AuthTokenCreate200ResponseAllOf> {
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsRejectCreate(jiraApiKey: string, flawId: string, reject: Reject, options?: any): AxiosPromise<AuthTokenCreate200ResponseAllOf> {
...
export class OsidbApi extends BaseAPI {
     ...
     * @memberof OsidbApi
     */
    public osidbApiV1AlertsList(alertType?: 'ERROR' | 'WARNING', excludeFields?: Array<string>, includeFields?: Array<string>, limit?: number, name?: string, offset?: number, parentModel?: 'affect' | 'affectcvss' | 'flaw' | 'flawacknowledgment' | 'flawcomment' | 'flawcvss' | 'flawmeta' | 'flawreference' | 'package' | 'snippet' | 'tracker', parentUuid?: string, uuid?: string, options?: AxiosRequestConfig) {
