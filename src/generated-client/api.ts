 ...
 * @export
 */
export type FlawSource = BlankEnum | Source521Enum;
...
export type Source521Enum = typeof Source521Enum[keyof typeof Source521Enum];
...
export const OsidbApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'CVEORG' | 'NIST' | 'OSV' | 'RH'} [issuer] 
         * @param {number} [limit] Number of results to return per page.
         * @param {number} [offset] The initial index from which to return the results.
         * @param {number} [score] 
         ...
         * @param {'CVEORG' | 'NIST' | 'OSV' | 'RH'} [cvssScoresIssuer] 
         ...
         * @param {string} [query] Advanced filter with special syntax. See https://github.com/ivelum/djangoql for more information.
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsRetrieve: async (id: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, query?: string, trackerIds?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @param {string} id A string representing either the internal OSIDB UUID of the Flaw resource or the CVE number corresponding to a Flaw
         * @param {Flaw} flaw 
         * @param {boolean} [createJiraTask] If set to true, it will trigger the creation of a Jira task if the flaw doesn\&#39;t already have one associated.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        osidbApiV1FlawsUpdate: async (bugzillaApiKey: string, jiraApiKey: string, id: string, flaw: Flaw, createJiraTask?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'bugzillaApiKey' is not null or undefined
            ...
            if (createJiraTask !== undefined) {
                localVarQueryParameter['create_jira_task'] = createJiraTask;
            }
...
export const OsidbApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1FlawsRetrieve(id: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, query?: string, trackerIds?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1FlawsCreate201Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.osidbApiV1FlawsRetrieve(id, excludeFields, includeFields, includeMetaAttr, query, trackerIds, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1FlawsUpdate(bugzillaApiKey: string, jiraApiKey: string, id: string, flaw: Flaw, createJiraTask?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1FlawsCreate201Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.osidbApiV1FlawsUpdate(bugzillaApiKey, jiraApiKey, id, flaw, createJiraTask, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * HTTP get /manifest
         ...
         * @throws {RequiredError}
         */
        async osidbApiV1TrackersUpdate(bugzillaApiKey: string, jiraApiKey: string, uuid: string, tracker: Tracker, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OsidbApiV1TrackersRetrieve200Response>> {
...
export const OsidbApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsRetrieve(id: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, query?: string, trackerIds?: Array<string>, options?: any): AxiosPromise<OsidbApiV1FlawsCreate201Response> {
            return localVarFp.osidbApiV1FlawsRetrieve(id, excludeFields, includeFields, includeMetaAttr, query, trackerIds, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} bugzillaApiKey User generated api key for Bugzilla authentication.
         ...
         * @throws {RequiredError}
         */
        osidbApiV1FlawsUpdate(bugzillaApiKey: string, jiraApiKey: string, id: string, flaw: Flaw, createJiraTask?: boolean, options?: any): AxiosPromise<OsidbApiV1FlawsCreate201Response> {
            return localVarFp.osidbApiV1FlawsUpdate(bugzillaApiKey, jiraApiKey, id, flaw, createJiraTask, options).then((request) => request(axios, basePath));
        },
        /**
         * HTTP get /manifest
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        osidbApiV1TrackersUpdate(bugzillaApiKey: string, jiraApiKey: string, uuid: string, tracker: Tracker, options?: any): AxiosPromise<OsidbApiV1TrackersRetrieve200Response> {
...
export class OsidbApi extends BaseAPI {
     ...
     * @memberof OsidbApi
     */
    public osidbApiV1FlawsRetrieve(id: string, excludeFields?: Array<string>, includeFields?: Array<string>, includeMetaAttr?: Array<string>, query?: string, trackerIds?: Array<string>, options?: AxiosRequestConfig) {
        return OsidbApiFp(this.configuration).osidbApiV1FlawsRetrieve(id, excludeFields, includeFields, includeMetaAttr, query, trackerIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OsidbApi
     */
    public osidbApiV1FlawsUpdate(bugzillaApiKey: string, jiraApiKey: string, id: string, flaw: Flaw, createJiraTask?: boolean, options?: AxiosRequestConfig) {
        return OsidbApiFp(this.configuration).osidbApiV1FlawsUpdate(bugzillaApiKey, jiraApiKey, id, flaw, createJiraTask, options).then((request) => request(this.axios, this.basePath));
    }
