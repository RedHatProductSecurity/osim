import type {
  ZodAegisAICVEAnalysisParamsType,
  ZodAegisAIComponentAnalysisParamsType,
  ZodAegisAICVEAnalysisWithContextParamsType,
...
function aegisaiRequestHeaders() {
  return new Headers({
...
export class AegisAIService {
   ...
   */
  async analyzeComponent(params: ZodAegisAIComponentAnalysisParamsType): Promise<any> {
    try {
   ...
   */
  async analyzeCVE(params: ZodAegisAICVEAnalysisParamsType): Promise<any> {
    try {
      const result = await aegisaiFetch({
        method: 'GET',
        url: '/analysis/cve',
   ...
   * @returns AI-generated analysis response
   */
  async analyzeCVEWithContext(params: ZodAegisAICVEAnalysisWithContextParamsType): Promise<any> {
    try {
